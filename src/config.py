...
class Settings(BaseSettings):
    ...
    # Path settings
    VECTOR_DB_PATH: str = Field(os.getenv("VECTOR_DB_PATH", os.path.join(PROJECT_ROOT, "data", "vector_db")))
    PDF_DIR: str = Field(os.getenv("PDF_DIR", os.path.join(PROJECT_ROOT, "data", "pdfs")))
    
    # Model settings
    MODEL_NAME: str = Field(os.getenv("MODEL_NAME", "gpt-3.5-turbo"))
    ANTHROPIC_MODEL_NAME: str = Field(os.getenv("ANTHROPIC_MODEL_NAME", "claude-3-haiku-20240307"))
